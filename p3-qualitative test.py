...
#plot
nx=range(5,90,5)
plt.xlabel('Number of taxis in operation')
plt.ylabel("Maximum profits")
plt.title('Maximum profits vs. Number of taxis in operation')
plt.plot(nx,gm,marker=".")
plt.savefig("p1.png")